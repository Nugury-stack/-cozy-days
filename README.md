게임 제목 뜻:  Cozy Days? (아늑한 날들?)

꿈속에서 플레이어가 죽었을 때 잠에서 깨야 하는데 게임을 클리어 할 때 까지 꿈에서 깰 수 없는 내용

-게임의 내용과 반대 되는 제목을 선정
...
통과 하는 길목은 둘 중 하나이며 문윗쪽에 
퀴즈를 풀면 정답인 길을 알려줌.

<img width="900" height="506" alt="image" src="https://github.com/user-attachments/assets/8bda6901-a2bc-4779-8331-dc8d13806936" />

설원 – 미로탈출

테마 그대로 미로 탈출이며 
미로에 숨겨진 아이템을 모두 획득하고
결승지점까지 찾아가면 게임을 클리어미로라는 특성 때문에 가장 난이도가 높고 시간이 오래 걸림.
